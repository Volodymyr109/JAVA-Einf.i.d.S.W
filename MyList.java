 ...
 *
 */
public class MyList<E> implements Cloneable, Accept {
	...
	public void accept(Visitor v) {
		MyEntry<E> current = this.pos;

		boolean continueVisiting = true;
		while(current.next != null && continueVisiting) {
			continueVisiting = v.visit(current.next.o);
